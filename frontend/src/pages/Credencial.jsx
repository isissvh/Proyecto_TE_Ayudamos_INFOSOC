  ...
  return (
    <div style={{ padding: "40px" }}>
      <HighlightArticle title="Credencial de Discapacidad">
        ...
        <AcordeonItem title="¿Qué es la Credencial de Discapacidad?">
          <p>
        ...
        <AcordeonItem title="¿Quiénes pueden solicitarla en nombre de un menor de edad?">
          <p>
            Su madre, padre o{" "}
        ...
        <AcordeonItem title="¿Cómo obtener la Credencial de Discapacidad?">       
          <h4>
        ...
        <AcordeonItem title="Beneficios de tener la Credencial de Discapacidad">  
          <p>
